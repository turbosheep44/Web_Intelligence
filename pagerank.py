...
with open("pagerank.json", "w") as pagerank_output_file:
...
for person_id in rank_dict:
    with open(f"node_data/{person_id}.json", "r") as person_data_file:
    ...
    # rewrite the file
    with open(f"node_data/{person_id}.json", "w") as person_data_file:
